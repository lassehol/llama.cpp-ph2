...
python3 ./G24A_writer.py

echo
echo "---- G24A source markers ----"
grep -n "mul_mat\|ggml_mul\|ggml_add\|soft_max\|sum_rows\|scale residency\|scaled residency\|residual residency\|prob residency\|residual branch isolation\|REDUCE_SUM_ROWS_F32\|expected 5 graph" \
    ggml/src/ggml-cuda8/ggml-cuda8-ggml-backend-graph-builder-q8_0-residual-scale-add-softmax-sumrows-smoke.cpp || true
