...
# G18C_writer.py
#
# Create G18C real graph-builder three-op quantized pipeline smoke:
#
#   h      = mul_mat(Q8_0, x)
#   scaled = h * scale
#   y      = scaled + bias
#
# The writer derives from the validated G18A Q8_0 -> ADD smoke.
...
SRC_OUT = os.path.join(BASE, "ggml-cuda8-ggml-backend-graph-builder-q8_0-mul-add-smoke.cpp")
CMAKE = os.path.join(BASE, "CMakeLists.txt")

TARGET = "ggml-cuda8-ggml-backend-graph-builder-q8_0-mul-add-smoke"

OLD_NAME = "ggml-cuda8-ggml-backend-graph-builder-q8_0-add-smoke"
NEW_NAME = "ggml-cuda8-ggml-backend-graph-builder-q8_0-mul-add-smoke"
...
# Add scalar reference helper before CPU Q8_0 MMV reference.
helper_insert = r'''
