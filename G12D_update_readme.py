...
if not os.path.exists(README):
    ...
    backup = README + ".g12d-backup-" + str(int(time.time()))
    write_file(backup, old)
    print("backup", backup)

# Remove older G11/G11C status blocks if present, so the README has one canonical status block.
...
print("G12D README status update complete.")
