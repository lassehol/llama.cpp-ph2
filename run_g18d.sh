...
grep -n "G17 real\|G18 real\|q8_0-mmv\|q8_0-add\|q8_0-mul-add\|CUDA8 G18D" ./run_g11_regression.sh || true

echo
echo "---- README G18 status markers ----"
grep -n "G18 status\|G18A\|G18B\|G18C\|G18D\|MUL_SCALAR" ggml/src/ggml-cuda8/README.md || true
